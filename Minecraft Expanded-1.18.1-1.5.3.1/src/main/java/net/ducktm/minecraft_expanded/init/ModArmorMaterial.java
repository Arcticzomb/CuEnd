...
public enum ModArmorMaterial implements ArmorMaterial{
    ...
    COPPER("copper", 12, new int[] {1, 4, 5, 2}, 0,
            SoundEvents.ARMOR_EQUIP_IRON, 0f, 0f, () -> {
        return Ingredient.of(Items.COPPER_INGOT);
    }),

    CHORISIUM("chorisium", 40, new int[] {3, 6, 8, 3}, 20,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 4f, 0.2f, () -> {
        return Ingredient.of(ModItems.CHORISIUM_INGOT.get());
    });
    ...
    public String getName() {
        return MinecraftExpanded.MOD_ID + ":" + this.name;
    }
