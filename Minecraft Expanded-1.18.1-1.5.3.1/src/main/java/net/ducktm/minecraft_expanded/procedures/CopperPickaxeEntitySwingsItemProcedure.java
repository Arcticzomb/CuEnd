...
public class CopperPickaxeEntitySwingsItemProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if ((world.getBlockState(new BlockPos((int) (entity.getX()), (int) (entity.getY() - 1), (int) (entity.getZ()))))
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
					.getItem() == ModItems.COPPER_PICKAXE.get()) {
				if (entity instanceof LivingEntity _entity)
					_entity.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 80, 2, (false), (false)));
			}
		}
	}
}
